...
from tic_tac_toe_x import TicTacToeXGameSpec
...
NETWORK_FILE_PATH = "testnetworkP2.p"#'current_network.p'  # path to save the network to
NUMBER_OF_GAMES_TO_RUN = 1000000 #originally 1000000
...
game_spec = TicTacToeXGameSpec(6,5) #6,5 fpr pentago

create_network_func = functools.partial(create_network, game_spec.board_squares(), (100, 100, 100), 36)

variables = train_policy_gradients(game_spec, create_network_func, NETWORK_FILE_PATH,
